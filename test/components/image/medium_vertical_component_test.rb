...
class Image::MediumVerticalComponentTest < ViewComponent::TestCase
  def test_component_renders_an_item_with_two_images
    ...
    render_inline(Image::MediumVerticalComponent.new(featured_image: first_image, item: item))
  ...
  def test_component_cuts_off_preview_images
    ...
    render_inline(Image::MediumVerticalComponent.new(featured_image: item.images.first, item: item))
