...
ActiveRecord::Schema.define(version: 20_220_209_020_921) do
  ...
  create_table 'items', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.virtual 'data_tsvector_col', type: :tsvector,
                                   as: "to_tsvector('english'::regconfig, (regexp_replace((data)::text, '([^a-z0-9]+)'::text, ' \\1 '::text, 'gi'::text))::jsonb)", stored: true
  ...
  create_table 'logs', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6
    t.index %w[associated_type associated_id], name: 'index_logs_on_associated_type_and_associated_id'
    t.index ['created_at'], name: 'index_logs_on_created_at'
    t.index ['entry'], name: 'index_logs_on_entry', using: :gin
    t.index %w[model_type model_id version], name: 'index_logs_on_model_type_and_model_id_and_version'
  ...
  create_table 'multiple_selects', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[field_id title], name: 'index_multiple_selects_on_field_id_and_title', unique: true
  ...
  create_table 'single_selects', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[field_id title], name: 'index_single_selects_on_field_id_and_title', unique: true
  ...
  create_table 'view_fields', force: :cascade do |t|
    ...
    t.index %w[view_id field_id], name: 'index_view_fields_on_view_id_and_field_id', unique: true
